...
iPad3 的屏幕（Retina 显示屏）即使放在今天，依然具备不错的显示素质。搭配驱动板 PCB800869 后，可以变成一台便携式显示器，适用于：
...
取出 14 个 M4 螺母，按 **每孔 2 颗** 的方式放入底壳指定孔位中。
...
使用手机支架、挡板和 3 个 M4 螺丝，将屏幕整体与手机支架通过挡板夹紧，用 M4 螺丝固定。
...
- 确认屏幕排线与驱动板型号匹配（PCB800869 专为 iPad3 屏幕设计）
